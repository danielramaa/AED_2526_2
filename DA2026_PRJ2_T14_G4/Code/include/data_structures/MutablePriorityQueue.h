 ...
 * @brief Mutable priority queue from the DA TP classes.
 *
 * Pulled in by Graph.h (template friend declaration only). Unused by the
 * register-allocation algorithms themselves but kept so the provided graph
 * data structure compiles unchanged.
 *
